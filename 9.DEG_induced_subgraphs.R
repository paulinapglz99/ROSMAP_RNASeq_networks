...
DEGS <- vroom::vroom(file = "ROSMAP_DLFPC_DEGS_dichoNIAReagan.txt")

#Graphs

graph_0 <- read_graph(file = "ROSMAP_RNAseq_DLPFC_noAD_MutualInfograph_percentile99.99.graphml", format = "graphml")  
graph_1 <-  read_graph(file = "ROSMAP_RNAseq_DLPFC_AD_MutualInfograph_percentile99.99.graphml", format = "graphml")  
